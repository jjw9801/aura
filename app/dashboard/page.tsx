...
export default function DashboardPage() {
  const quickActions = [
    ...
    { icon: "📁", title: "Files", desc: "Manage your documents", href: "/dashboard/files" },
  ];
          ...
          {quickActions.map((action, i) => (
            <Link key={i} href={action.href}>
              <motion.div
                ...
                className="p-5 rounded-[24px] border border-[#27272A] bg-[#18181B] hover:border-[#7C3AED]/50 hover:shadow-[0_10px_40px_rgba(124,58,237,.18)] transition-shadow duration-300 cursor-pointer h-full"
              >
      ...
      <motion.div custom={7} variants={fadeUp} initial="hidden" animate="visible">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            { name: "Gemini", status: "Available", color: "#22C55E" },
          ].map((model, i) => (
            <div
              key={i}
